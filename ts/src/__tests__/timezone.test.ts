...
it('Add Time days (DST)', () => {
  ...
  // New Zealand (-720)
  expect(dayjs('2018-04-01').add(1, 'day').format()).toBe(
    moment('2018-04-01').add(1, 'd').format()
  )
  expect(dayjs('2018-03-28').add(1, 'week').format()).toBe(
    moment('2018-03-28').add(1, 'w').format()
  )
  // London (-60)
  expect(dayjs('2018-10-28').add(1, 'day').format()).toBe(
    moment('2018-10-28').add(1, 'd').format()
  )
  expect(dayjs('2018-10-26').add(1, 'week').format()).toBe(
...
it('Diff (DST)', () => {
  ...
  const dayjsB = dayjs(day).add(-1000, 'day')
...
it('UTC diff in DST', () => {
  ...
  expect(day1.diff(day2, 'day')).toBe(-3)
})
